...
function Termsandconditions() {
  return (
    <div className="container">
      ...
      <h4 className="text-light pt-5 pb-3">DISCLAIMER</h4>{" "}
      <p>
        Any new features or tools which are added to the current website shall
        also be subject to the Terms of Service. You can review the most current
        version of the Terms of Service at any time on this page. We reserve the
      ...
      <h4 className="text-light pt-5 pb-3">GENERAL TERMS: </h4>{" "}
      <p>
      ...
      <h4 className="text-light pt-5 pb-3">GENERAL CONDITIONS: </h4>{" "}
      <p>
        By agreeing to these Terms of Service, you represent that you are at
        least the age of majority in your state or province of residence. You
        may not use our products for any illegal or unauthorized purpose nor may
      ...
      <h4 className="text-light pt-5 pb-3">
      ...
      <p>
        ...
        update information related website is inaccurate at any time without
        prior notice (including after your Sign up).
      </p>
      <h4 className="text-light pt-5 pb-3">PROHIBITED USES:</h4>
      <p>
      ...
      <h4 className="text-light pt-5 pb-3">TERMINATION:</h4>
      <p>
      ...
      <h4 className="text-light pt-5 pb-3">
        AGREEMENT TO RESPECT LOCAL, STATE AND FEDERAL LAW:
      </h4>
      <p>
        By using this site, you represent that you are willing to respect and
        obey Local, State and Federal laws governing the use of home extraction.
      </p>
      <h4 className="text-light pt-5 pb-3">ENTIRE AGREEMENT:</h4>
      <p>
      ...
      <h4 className="text-light pt-5 pb-3">CHANGES TO TERMS OF SERVICE:</h4>
      <p>
